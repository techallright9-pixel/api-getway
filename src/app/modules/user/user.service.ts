...
const createStudent = async (req: Request) => {
  ...
  if (
    ...
    Array.isArray(academicDepartmentResponse.data && academicDepartmentResponse.data.length > 0)
  ) {
  ...
  if (
    ...
    Array.isArray(academicFacultyResponse.data && academicFacultyResponse.data.length > 0)
  ) {
  ...
  if (
    ...
    Array.isArray(academicSemesterResponse.data && academicSemesterResponse.data.length > 0)
  ) {
